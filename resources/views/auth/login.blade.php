        ...
        <div class="login-page__card">
            ...
            <div class="login-page__card-body">
                ...
                <form id="js-login-form" onsubmit="promptAlert(event)" class="login-page__form" action="{{ route('login') }}" method="post">
                    ...
                    <div class="form-group ">
                        <label class="custom-radio-button text-white">I understand that the choices I will make is influenced by my
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-lg client-custom-button-2">Sign In</button>
                    </div>
